  ...
  return (
    <div className="grid lg:grid-cols-6 grid-cols-1 md:grid-cols-2 mx-[5rem] gap-10 mb-20">
      {componentInfo?.map((info: any) => (
        <div
          className="card  bg-base-100 shadow-2xl border  bg-gradient-to-tr from-slate-200 to-bg-purple-400"
          key={info.id}
        >
          <figure>
            <Image
          ...
          <div className="card-body">
            <h2 className="card-title text-sm font-semibold">{info.name}</h2>
